...
GitHub Repo:
 ...
 - [BusyBox](https://github.com/nicle-lin/dockerV1.2.0/docker/blob/master/contrib/mkimage-busybox.sh)
 - CentOS / Scientific Linux CERN (SLC) [on Debian/Ubuntu](
   https://github.com/nicle-lin/dockerV1.2.0/docker/blob/master/contrib/mkimage-rinse.sh) or
   [on CentOS/RHEL/SLC/etc.](
   https://github.com/nicle-lin/dockerV1.2.0/docker/blob/master/contrib/mkimage-yum.sh)
 - [Debian / Ubuntu](
   https://github.com/nicle-lin/dockerV1.2.0/docker/blob/master/contrib/mkimage-debootstrap.sh)
