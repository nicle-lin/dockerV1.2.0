...
streams]( https://github.com/nicle-lin/dockerV1.2.0/docker/blob/
...
https://github.com/nicle-lin/dockerV1.2.0/docker/blob/master/daemon/execdriver/lxc/lxc_template.go)
