...
<table border="1" class="docutils">
  ...
  Install via NPM: <cite>npm install docker.io</cite></td>
    ...
    <tr class="row-even">
      <td>Java</td>
      <td>docker-java</td>
      <td><a class="reference external" href="https://github.com/nicle-lin/dockerV1.2.0-java/docker-java">https://github.com/nicle-lin/dockerV1.2.0-java/docker-java</a></td>
      <td>Active</td>
    </tr>
    <tr class="row-odd">
      <td>Erlang</td>
