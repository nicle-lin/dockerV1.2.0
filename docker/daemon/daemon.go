...
import (
	...
	"github.com/nicle-lin/dockerV1.2.0/libcontainer/label"

	"github.com/nicle-lin/dockerV1.2.0/docker/archive"
	"github.com/nicle-lin/dockerV1.2.0/docker/daemon/execdriver"
	"github.com/nicle-lin/dockerV1.2.0/docker/daemon/execdriver/execdrivers"
	...
	_ "github.com/nicle-lin/dockerV1.2.0/docker/daemon/graphdriver/vfs"
	_ "github.com/nicle-lin/dockerV1.2.0/docker/daemon/networkdriver/bridge"
	"github.com/nicle-lin/dockerV1.2.0/docker/daemon/networkdriver/portallocator"
	...
	"github.com/nicle-lin/dockerV1.2.0/docker/pkg/broadcastwriter"
	"github.com/nicle-lin/dockerV1.2.0/docker/pkg/graphdb"
	"github.com/nicle-lin/dockerV1.2.0/docker/pkg/log"
	"github.com/nicle-lin/dockerV1.2.0/docker/pkg/namesgenerator"
	"github.com/nicle-lin/dockerV1.2.0/docker/pkg/networkfs/resolvconf"
	"github.com/nicle-lin/dockerV1.2.0/docker/pkg/parsers"
	"github.com/nicle-lin/dockerV1.2.0/docker/pkg/parsers/kernel"
	"github.com/nicle-lin/dockerV1.2.0/docker/pkg/sysinfo"
	"github.com/nicle-lin/dockerV1.2.0/docker/pkg/truncindex"
...
func checkKernelAndArch() error {
	...
	// For details see http://github.com/nicle-lin/dockerV1.2.0/docker/issues/407
