...
* A clean checkout of the source added to a valid [Go
  ...
  *src/github.com/nicle-lin/dockerV1.2.0/docker* (unless you plan to use `AUTO_GOPATH`,
...
* a [properly
  ...
  [is](https://github.com/nicle-lin/dockerV1.2.0/docker/issues/2683)
  [not](https://github.com/nicle-lin/dockerV1.2.0/docker/issues/3485)
  [sufficient](https://github.com/nicle-lin/dockerV1.2.0/docker/issues/4568))
